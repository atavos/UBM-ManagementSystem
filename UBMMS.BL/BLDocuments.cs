...
namespace UBMMS.BL
{
    ...
    {
        public void AssignDocuments(string customerName, string projectCode, string documentType, user u)
        {
            DALDocuments dal = new DALDocuments();
            dal.AssignDocuments(customerName, projectCode, documentType, u);
        }

        public object SelectAllByUser(user user)
        {
            DALDocuments dal = new DALDocuments();
            return dal.SelectAllByUser(user);
        }
        ...
        public string GetDocumentImage(string trackingID)
        {
            try
            {
                ...
                ftp.download(folder + @"/" + trackingID + ".pdf", @"C:\UBMMSTemp\" + trackingID + ".pdf");
                return @"C:\UBMMSTemp\" + trackingID + ".pdf";
            }
            catch(Exception ex)
            {
